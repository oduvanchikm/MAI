        ...
        else
        {
            ...
            else
            {
                ...
                else if (strcmp(flag, "%to") == 0)
                {
                    ...
                    {
                        fprintf(file, "digit is not in lowercase");
                    }
                }
                ...
                else if (strcmp(flag, "%TO") == 0)
                {
                    ...
                    {
                        fprintf(file, "digit is not in uppercase");
                    }
                }
        ...
        else
        {
            ...
            else
            {
                ...
                else if (strcmp(flag, "%to") == 0)
                {
                    ...
                    {
                        buffer_index += sprintf(&(buffer[buffer_index]), "digit is not in lowercase");
                    }
                }
                ...
                else if (strcmp(flag, "%TO") == 0)
                {
                    ...
                    {
                        buffer_index += sprintf(&(buffer[buffer_index]), "digit is not in uppercase");
                    }
